...
const OrderReceivedEmail = ({
  ...
  const basedUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-blush-xi.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>
              if you have any questions regarding your order, please free to
              contact us with your order number and we're help to help
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any questions. (if you replay to
