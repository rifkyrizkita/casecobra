...
function ReviewColumn({
  ...
  return (
    <div
      ref={columnRef}
      className={cn("animate-marquee space-y-8 py-4", classsName)}
...
function ReviewGrid() {
  ...
  return (
    <div
      ref={containerRef}
      className="mas-h-[150vh] relative -mx-4 mt-16 grid h-[49rem] grid-cols-1 items-start gap-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3"
    >
      {isInView ? (
        <>
          <ReviewColumn
